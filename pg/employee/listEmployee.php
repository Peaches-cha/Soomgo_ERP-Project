...
<html lang="en">
   ...
   <body>
               ...
               <div class="row" >
                  <div class="col-xl-12">
                    <section class="hk-sec-wrapper">
                            <h5 class="hk-sec-title">사원 조회</h5>
                            <p class="mb-40">Employee List</p>
                            <div class="row">
                                <div class="col-sm">
      ...
      function AddRow(id, name, phone, position, code, account_name, account_code, date){
        $("#employee-list").append(""+
          "<tr>"+
              ...
              "<td>"+date+"</td>"+
              "<td>"+
                  "<a href=\"<?php $_SERVER['DOCUMENT_ROOT']?>/pg/employee/updateEmployee.php?id=" + id +"\" class=\"mr-25\" data-toggle=\"tooltip\" data-original-title=\"Edit\"> <i class=\"icon-pencil\"></i> </a>"+
                  "<a href=\"<?php $_SERVER['DOCUMENT_ROOT']?>/form/form_employee/deleteEmployee.php?id="+id+"\" data-toggle=\"tooltip\" data-original-title=\"Close\"> <i class=\"icon-trash txt-danger\"></i> </a>"+
              "</td>"+
          "</tr>"
        );
      }
